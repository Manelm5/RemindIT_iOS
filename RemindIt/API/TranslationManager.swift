...
class TranslationManager: NSObject {
    ...
    //apikey will always be a urlparam
    ...
    //completion : metodo que no se cuando va a acabar
    ...
    func translate(forText text: String, originalLanguage originalL: String, translateLanguage translateL: String, completion: @escaping (_ language: String?) -> Void) {
      
         var urlParams = [String: String]()
         urlParams["key"] = apiKey
         urlParams["q"] = text
         urlParams["target"] = translateL
         urlParams["format"] = "text"
         urlParams["source"] = originalL
